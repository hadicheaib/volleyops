...
// â”€â”€ Stats Edit Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 480 }}>
        <div className="modal-header">
          <span className="modal-title">Edit Stats â€” {player.name}</span>
        ...
        <form onSubmit={submit}>
          ...
          <div className="form-actions">
            ...
            <button type="submit" className="btn btn-primary" disabled={loading}>{loading ? 'Savingâ€¦' : 'Save Stats'}</button>
          </div>
        </form>
      </div>
    </div>
...
// â”€â”€ Pagination control â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function Pagination({ page, total, pageSize, onChange }) {
  const pages = Math.ceil(total / pageSize)
  if (pages <= 1) return null
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, justifyContent: 'flex-end', marginTop: 16 }}>
      <button className="btn btn-secondary btn-sm" disabled={page <= 1} onClick={() => onChange(page - 1)}>â€¹ Prev</button>
      <span style={{ fontSize: 13, color: 'var(--text-muted)' }}>Page {page} of {pages}</span>
      <button className="btn btn-secondary btn-sm" disabled={page >= pages} onClick={() => onChange(page + 1)}>Next â€º</button>
    </div>
  )
}
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <div className="page-subtitle">{total} total Â· manage registration status and team assignments</div>
        </div>
      </div>
      ...
      <div className="filter-row">
        ...
        <div className="search-wrap" style={{ marginLeft: 'auto' }}>
          <input className="search-input" placeholder="Search playersâ€¦" value={filters.search}
                  ...
                  <tbody>
                    {players.map((p) => (
                      <tr key={p.id} style={{ cursor: 'pointer' }} onClick={() => setSelected(p.id)}>
                        ...
                        <td>{POSITION_LABELS[p.position] || <span style={{ color: 'var(--text-dim)' }}>â€”</span>}</td>
          ...
          <div className="card" style={{ width: 260, flexShrink: 0 }}>
            ...
            {canManage && (
              <button className="btn btn-secondary" style={{ width: '100%', justifyContent: 'center', marginTop: 16 }}
                onClick={() => setStatsPlayer(selectedPlayer)}>ðŸ“Š Edit Stats</button>
            )}
            {isAdmin && selectedPlayer.registration_status === 'pending' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginTop: 8 }}>
                <button className="btn btn-green" disabled={working} onClick={() => updateStatus(selectedPlayer.id, 'approved')} style={{ justifyContent: 'center' }}>âœ“ Approve</button>
                <button className="btn btn-yellow" disabled={working} onClick={() => updateStatus(selectedPlayer.id, 'waitlisted')} style={{ justifyContent: 'center' }}>â³ Waitlist</button>
                <button className="btn btn-pink" disabled={working} onClick={() => updateStatus(selectedPlayer.id, 'rejected')} style={{ justifyContent: 'center' }}>âœ• Reject</button>
              </div>
            )}
          </div>
        )}
